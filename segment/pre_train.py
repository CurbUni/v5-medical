...
Usage - Multi-GPU DDP training:
    ...
    python -m torch.distributed.launch --nproc_per_node 4 segment/pre_train.py --data coco128-seg1.yaml --img 640 --device 0,1,2,3
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    print("---------------------Start Training------------------------")
    print("---------------------Start Training------------------------")
    path_checkpoint = '/21TB/yk/codes/v5-medical/new_best_yolopBackbone.pth'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/21TB/yk/codes/v5-medical/models/segment/yolov5l-seg-own.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg1.yaml', help='dataset.yaml path')
